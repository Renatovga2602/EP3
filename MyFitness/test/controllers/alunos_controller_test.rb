...
class AlunosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post alunos_url, params: { aluno: { altura: @aluno.altura, email: @aluno.email, nome: @aluno.nome, peso: @aluno.peso, telefone: @aluno.telefone } }
    end
  ...
  test "should update aluno" do
    patch aluno_url(@aluno), params: { aluno: { altura: @aluno.altura, email: @aluno.email, nome: @aluno.nome, peso: @aluno.peso, telefone: @aluno.telefone } }
